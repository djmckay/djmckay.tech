...
struct WebsiteController: RouteCollection {
    ...
    func indexHandler(_ req: Request) throws -> Future<View> {
        ...
        let context = IndexContext(brand: "DJ McKay", social: Social(github: "djmckay", linkedIn: "djmckay17988844", twitter: "dj_mckay", facebook: nil), title: "DJ McKay.tech", portfolio: Portfolio(projects: [thisSite, countdown, vztuf, vztufShowManagement, vztufRegistrationDesk, vztufQRScanner, bespin]))
